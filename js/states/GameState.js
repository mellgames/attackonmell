...
AttackOnBall.GameState.prototype.create = function () {
  ...
  this.runSound = game.add.audio(SOUNDS.RUN);
    this.deathSound = game.add.audio(SOUNDS.DEATH);
    this.collectSound = game.add.audio(SOUNDS.COLLECT);
    this.bgMusic = game.add.audio(SOUNDS.BACKGROUND);
